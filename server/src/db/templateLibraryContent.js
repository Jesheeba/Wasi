...
const ECOMMERCE = [
  ...
  },
  {
    ...
    body: 'Hi {{customer_name}}, thanks so much for shopping with us! Your order {{order_id}} for {{item_name}} has been confirmed and our team is getting it ready for you now.',
    footer: null,
  ...
  },
  {
    ...
    body: 'Good news, {{customer_name}}! Your order {{order_id}} has just shipped and is now on its way to you. Expected delivery date: {{delivery_date}} — we hope you love it.',
    footer: null,
  ...
  },
  {
    ...
    body: "Hi {{customer_name}}, as a thank you for being our customer, enjoy {{discount_percent}} percent off your very next order when you use code {{promo_code}} at checkout. This offer is valid through {{expiry_date}}, so don't wait too long.",
    footer: 'Reply STOP to unsubscribe',
  ...
  },
  {
    ...
    body: "Hi {{customer_name}}, we just need a quick confirmation for your cash-on-delivery order {{order_id}}, totaling {{amount}}. Reply YES to confirm it's on its way, or NO to cancel.",
    footer: null,
  ...
  },
  {
    ...
    body: 'Hi {{customer_name}}, good news — the price of {{item_name}} you were looking at just dropped to {{new_price}}. Grab it soon before the price changes again.',
    footer: 'Reply STOP to unsubscribe',
...
const HEALTHCARE = [
  {
    ...
    body: 'Hi {{patient_name}}, this is a friendly reminder about your upcoming appointment with {{doctor_name}}, scheduled for {{appointment_date}} at {{appointment_time}}. We look forward to seeing you then, and please let us know if anything changes.',
    footer: null,
  ...
  },
  {
    ...
    body: 'Hi {{patient_name}}, your appointment with {{doctor_name}} has been confirmed for {{appointment_date}} at {{appointment_time}}. Please try to arrive about 10 minutes early so our front desk team can get you checked in smoothly.',
    footer: null,
    buttons: null,
    sample_values: { patient_name: 'Arjun', doctor_name: 'Dr. Mehta', appointment_date: 'August 30', appointment_time: '4:00 PM' },
  },
  {
    ...
    body: 'Hi {{patient_name}}, your appointment with {{doctor_name}} has been moved and is now scheduled for {{new_date}} at {{new_time}}. Please let us know as soon as possible if this new time does not work for you.',
    footer: null,
    buttons: null,
  ...
  },
  {
    ...
    body: "Hi {{patient_name}}, your appointment with {{doctor_name}} on {{appointment_date}} has been cancelled as requested. Please reach out and contact us whenever you're ready to schedule a new time.",
    footer: null,
  ...
  },
  {
    ...
    body: 'Hi {{patient_name}}, your prescription for {{medicine_name}} is now ready and waiting for pickup at {{pharmacy_name}}. Please remember to bring a valid photo ID with you.',
    footer: null,
    buttons: null,
  ...
  },
  {
    ...
    body: 'Hi {{patient_name}}, this is a friendly reminder that your {{vaccine_name}} dose is due on {{due_date}}. Please book an appointment at your earliest convenience to stay protected.',
    footer: null,
  ...
  },
  {
    ...
    body: 'Hi {{patient_name}}, your outstanding balance of {{amount}} for your recent visit is due by {{due_date}}. Please feel free to contact our billing office if you have any questions.',
    footer: null,
  ...
  },
  {
    ...
    body: 'Hi {{patient_name}}, your video consultation with {{doctor_name}} is scheduled to start at {{appointment_time}}. Please join using the link below a few minutes early to test your connection.',
    footer: null,
...
const GENERAL = [
  ...
  },
  {
    ...
    body: "Hi {{customer_name}}, please complete your payment of {{amount}} using the secure link below whenever you're ready. Note that this link expires on {{expiry_date}}.",
    footer: null,
  ...
  },
  {
    ...
    body: "Hi {{attendee_name}}, you're all set — you are confirmed for {{event_name}}, happening on {{event_date}}. We look forward to seeing you there in person.",
    footer: null,
    buttons: null,
  ...
  },
  {
    ...
    body: "Hi {{attendee_name}}, this is just a quick reminder that {{event_name}} is coming up soon — it starts on {{event_date}} at {{event_time}}. We can't wait to see you there in person!",
    footer: null,
    buttons: null,
  ...
  },
  {
    ...
    body: "Hi {{customer_name}}, we'd love for you to join our upcoming webinar on {{topic}}, happening on {{event_date}}. Seats are limited, so reserve yours today before they fill up.",
    footer: 'Reply STOP to unsubscribe',
  ...
  },
  {
    ...
    body: "Hi {{customer_name}}, just a heads up that your {{plan_name}} subscription is set to renew on {{renewal_date}} for {{amount}}. No action is needed on your end if you'd like it to continue as normal.",
    footer: null,
    buttons: null,
  ...
  },
  {
    ...
    body: 'Hi {{customer_name}}, wishing you a very wonderful {{occasion}} from all of us here at {{business_name}}. Thank you so much for being a valued customer this year.',
    footer: 'Reply STOP to unsubscribe',
    buttons: null,
